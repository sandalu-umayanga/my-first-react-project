...
export default function AttendantRegister() {
  useEffect(() => {
  ...
  const schema = yup.object().shape({
    ...
    status: yup.string().required("City is required"),
    ...
    <div>
      ...
      <Formik
        ...
        onSubmit={(values, {resetForm}) => {
          axios.post("http://localhost:8080/api/v1/attendant/saveAttendant", values)
            .then(response => {
